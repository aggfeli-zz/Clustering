...
void LinkedList::Search(int radius, string temp, string item, int counter, int * Row, string method, ofstream& file, int columns, Cluster ** cluster, int k)
{
    //cout << "!!!!!!!!!!!" << endl;
    int i = 0;
    ...
    while (p)
    {
        ...
        if (method == "@metric_space hamming")              //Choose method
        {
            ...
            {                           //If we found wanted distance print into file
                //cout <<  p->hamming_key->getName() << endl;
